...
pFNS.OPDD1              = 'demo/opdd_unreg_water_radiograph_default.mat'; % FOR SAVING, 1ST MATERIAL RADIOGRAPH 
pFNS.OPDD2              = 'demo/opdd_unreg_bone_radiograph_default.mat'; % FOR SAVING, 2ND MATERIAL RADIOGRAPH 
...
% OPDD HYPERPARAMETERS (MOST ARE USING DEFAULT SETUP, SO NOT LISTED HERE)
pPDD.MomentTruncate     = [-10 inf]; % LOWER AND UPPER WINDOW FOR VARIABLE (E.G., HERE, I ADDED A LOWER TRUNCATION OF -10)
